...
@Component({
  selector: 'app-electronics-and-jewelry',
  imports: [CommonModule, ProductCartComponent, RouterModule, FixedDecriptionLenPipe],
  templateUrl: './electronics-and-jewelry.component.html',
  styleUrl: './electronics-and-jewelry.component.css'
})
export class ElectronicsAndJewelryComponent {
  ...
  loadProducts() {
    this.ProductService.getElectronicAndJeweleryProducts().subscribe(data => {
