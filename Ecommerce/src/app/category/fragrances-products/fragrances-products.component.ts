...
@Component({
  selector: 'app-fragrances-products',
  imports: [CommonModule, ProductCartComponent, RouterModule, FixedDecriptionLenPipe],
  templateUrl: './fragrances-products.component.html',
  styleUrl: './fragrances-products.component.css'
})
export class FragrancesProductsComponent {
  ...
  loadProducts() {
    this.ProductService.getFragrancesProducts().subscribe(data => {
